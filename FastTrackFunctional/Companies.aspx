<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Companies.aspx.cs" Inherits="FastTrackFront.Companies" %>
               ...
               <Columns>
                   <asp:TemplateField>
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="Editbtn" CausesValidation="false" style="display: none;" runat="server" CommandArgument='<%#  Eval("CompanyID") %>' CommandName="EditRow"  ></asp:LinkButton>
                        </ItemTemplate>
                        <HeaderTemplate>
                              Edit
                       </HeaderTemplate>
                   ...
                   <asp:TemplateField>
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="Deletebtn" CausesValidation="false" style="display: none;" runat="server" CommandArgument='<%#  Eval("CompanyID") %>' CommandName="DeleteRow"  ></asp:LinkButton>
                        </ItemTemplate>
                        <HeaderTemplate>
                              Delete
                       </HeaderTemplate>
