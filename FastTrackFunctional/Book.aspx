<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Book.aspx.cs" Inherits="FastTrackFront.Book" %>
        ...
        <div class="container">
            <h3>Make a booking</h3><br>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <asp:Button runat="server" OnClick="btnBook_Click" style="border-radius: 5px;" class="btn-form1-submit mt-15" Text="BOOK" />
                    </div>
                </div>
        </div>
    </section>
