<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterCompany.aspx.cs" Inherits="FastTrackFront.RegisterCompany" %>
...
<body>
    ...
    <div style="height: 100vh;" class="banner-header section-padding valign bg-img bg-fixed" data-overlay-dark="3" data-background="img/slider/2.jpg">
        <div class="container">
            <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input1_wrapper">
                                            ...
                                            <div class="input1_inner">
                                                <input id="Name" runat="server" type="text" class="form-control" placeholder="Name">
                                            </div>
                                            <label  id="NameError" runat="server"  visible="false" style="color: red;">Name Required</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="input1_wrapper">
                                            ...
                                            <div class="input1_inner">
                                                <input  id="Description" runat="server"  type="text" class="form-control" placeholder="Description">
                                            </div>
                                            <label  id="DescriptionError" runat="server"  visible="false" style="color: red;">Description Required</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="input1_wrapper">
                                            ...
                                            <div class="input1_inner">
                                                <input  id="RegistrationNumber" runat="server"  type="number" class="form-control" placeholder="Registration Number">
                                            </div>
                                            <label  id="RegistrationNumberError" runat="server"  visible="false" style="color: red;">Registration Number Required</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
