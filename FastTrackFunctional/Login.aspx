<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="FastTrackFront.Login" %>
<!DOCTYPE html>
<html lang="zxx">
                    ...
                    <div class="booking-box">
                        ...
                        <div class="booking-inner clearfix">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <label id="InvalidDetails" runat="server"  visible="false" style="color: red;">Invalid Email OR Password.</label>
                                        <br/>
                                        <asp:Button runat="server" OnClick="btnLogin_Click" style="border-radius: 5px;" class="btn-form1-submit mt-15" Text="Login" />
                                    </div>
                                </div>
                        </div>
                    </div>
